	...
	postFormat : function(e) {
		if(e.story==null){
			...
			if(e.type=="status"){
				...
				if(e.likes == 1)
					$('<div>').addClass('clearfix').append($('<img>').attr('src', 'like-50.png').addClass('commentLike')).append($('<span>').html(e.likes + ' pessoa curtiu isso')).appendTo($('<li>').appendTo(listReplies));
				else if(e.likes > 1)
					$('<div>').addClass('clearfix').append($('<img>').attr('src', 'like-50.png').addClass('commentLike')).append($('<span>').html(e.likes + ' pessoas curtiram isso')).appendTo($('<li>').appendTo(listReplies));
				var i = 0;
